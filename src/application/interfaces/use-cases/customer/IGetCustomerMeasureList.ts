...
export interface IGetCustomerMeasureList
    extends UseCase<IGetCustomerMeasureList.Request, IGetCustomerMeasureList.Response> {
    execute(reqObj: IGetCustomerMeasureList.Request): Promise<IGetCustomerMeasureList.Response>;
}
